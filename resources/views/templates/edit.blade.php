...
@section('page-subtitle', 'Update message template')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-7">
        ...
        <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Edit Template</h2>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-5">
            ...
            <div>
                ...
                <textarea id="content" name="content" rows="6" required maxlength="1600"
                          class="w-full border border-slate-200 rounded-xl px-3.5 py-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none">{{ old('content', $template->content) }}</textarea>
            </div>
