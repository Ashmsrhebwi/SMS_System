...
@section('page-subtitle', 'Create a new contact tag')
...
<div class="max-w-lg mx-auto">
    ...
    <div class="flex items-center gap-4 mb-7">
        ...
        <h2 class="text-2xl font-bold text-slate-900 tracking-tight">New Tag</h2>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required maxlength="100"
                       ...
                       placeholder="e.g. VIP, Implant, Whitening">
            </div>
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2" x-data="{ selected: '{{ old('color', '#6366f1') }}' }">
                    @php
