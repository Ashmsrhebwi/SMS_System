...
class CountryDetectorService
{
    private static array $prefixes = [
        // 4-digit prefixes first (most specific)
        '+1242' => 'Bahamas',        '+1246' => 'Barbados',
        '+1264' => 'Anguilla',       '+1268' => 'Antigua & Barbuda',
        '+1284' => 'British Virgin Islands', '+1340' => 'US Virgin Islands',
        '+1345' => 'Cayman Islands', '+1441' => 'Bermuda',
        '+1473' => 'Grenada',        '+1649' => 'Turks & Caicos',
        '+1664' => 'Montserrat',     '+1671' => 'Guam',
        '+1684' => 'American Samoa', '+1721' => 'Sint Maarten',
        '+1758' => 'Saint Lucia',    '+1767' => 'Dominica',
        '+1784' => 'Saint Vincent',  '+1787' => 'Puerto Rico',
        '+1809' => 'Dominican Republic', '+1868' => 'Trinidad & Tobago',
        ...
        '+238' => 'Cape Verde',      '+239' => 'São Tomé & Príncipe',
        ...
        '+507' => 'Panama',          '+508' => 'Saint Pierre & Miquelon',
        '+509' => 'Haiti',           '+590' => 'Guadeloupe',
        '+591' => 'Bolivia',         '+592' => 'Guyana',
        '+593' => 'Ecuador',         '+594' => 'French Guiana',
        '+595' => 'Paraguay',        '+596' => 'Martinique',
        ...
        '+850' => 'North Korea',     '+852' => 'Hong Kong',
        '+853' => 'Macao',           '+855' => 'Cambodia',
        ...
        '+967' => 'Yemen',           '+968' => 'Oman',
        '+970' => 'Palestinian Territory', '+971' => 'UAE',
        ...
        // 1-digit prefix (widest match, lowest priority)
        '+1' => 'USA / Canada',
        '+7' => 'Russia / Kazakhstan',
    ];
    ...
    public static function detect(string $phone): string
    {
        for ($digits = 4; $digits >= 1; $digits--) {
            if (strlen($phone) > $digits) {
                $prefix = substr($phone, 0, $digits + 1); // +1 for '+'
    ...
    public static function prefix(string $phone): string
    {
        for ($digits = 4; $digits >= 1; $digits--) {
            if (strlen($phone) > $digits) {
                $prefix = substr($phone, 0, $digits + 1);
                if (isset(self::$prefixes[$prefix])) {
                    return $prefix;
                }
            }
